...
##  שימוש בכלי AI (AI Disclosure)

בפרויקט זה נעשה שימוש מתקדם בכלי בינה מלאכותית (כגון **GitHub Copilot, Gemini, GPT-4**) אשר שימשו כ־**Senior Architectural Partner** לאורך כל שלבי הפיתוח.
...
הקמת התשתית הראשונית, עבודה עם `FullName` וניהול קבצים (תמונות).

---

## חלק ב'

ביצוע Refactoring מקיף לפיצול שדות השם, הוספת סטטוס פעיל/לא־פעיל, הטמעת מנגנון חיפוש חכם והפקת דוחות PDF מעוצבים.

---

## חלק ג'

תיעוד תהליך העבודה מבוסס AI והצגת החלטות ארכיטקטוניות.
